...
% tags={'trnKatrina1_5km','trnKatrina2_5km','trnKatrina1_10km', ...
%     'trnKatrina2_10km','trnRita1_5km','trnRita2_5km','trnRita1_10km', ...
%     'trnRita2_10km'};
% res={5,5,10,10,5,5,10,10};

tags = {'l2b_merged_GS'}
res = {12.5}; % res is 5 or 10 km (what?)
...
%     inpt_s0meanvar_file=sprintf('jaxaAC_s0meanvar_%s.txt',tags{i});
    inpt_s0meanvar_file='Sim_050600_anndata.dat';	
    inpt_l2b_array_file='test_arrays.dat';
