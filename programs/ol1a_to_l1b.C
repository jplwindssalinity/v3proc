...
//
// SYNOPSIS
//    ol1a_to_l1b <sim_config_file>
//
// DESCRIPTION
//    Simulates the OVWM 1b ground processing of Level 1A to
    ...
    char*  argv[])
{
    ...
    OvwmL1AToL1B l1a_to_l1b;
    if (! ConfigOvwmL1AToL1B(&l1a_to_l1b, &config_list))
    {
        fprintf(stderr,
    ...
    do
    {
        ...
        if (! l1a_to_l1b.Convert(&l1a, &spacecraft, &ovwm, &ephemeris,
