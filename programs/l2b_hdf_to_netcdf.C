...
int main(int argc, char **argv) {
    ...
    ERR(l2b.SmartRead(run_config.l2bhdf_file) == 0);
...
int parse_commandline(int argc, char **argv, l2b_to_netcdf_config *config) {
    ...
    const char* usage_array = "--l2bhdf=<l2b hdf file> --l2bc=<l2bc file> --l1bhdf=<l1b hdf source file> [--extended]";
    int opt;
    ...
    {
        { "l2bhdf",   required_argument, NULL, 'i'},
