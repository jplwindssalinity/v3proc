...
//
// SYNOPSIS
//    mudh_reflag <threshold> <input_flag_file> <output_flag_file>
//
// DESCRIPTION
//    Performs reclassification based on the threshold.
//    The original file can be deleted.
...
//    <input_flag_file>   The input flag file.
//    <output_flag_file>  The output flag file.
//
// EXAMPLES
//    An example of a command line is:
//      % mudh_reflag 0.03 1550.pflag 1550.03.pflag
//
// ENVIRONMENT
...
const char* usage_array[] = { "<threshold>", "<input_flag_file>",
    "<output_flag_file>", 0 };
