...
#define L2BC_WIND_DIR_KW "wind_to_direction"
#define L2BC_MODEL_WIND_DIR_KW "model_wind_direction"
#define L2BC_WIND_SPEED_KW "wind_speed"
#define L2BC_MODEL_WIND_SPEED_KW "model_wind_speed"
