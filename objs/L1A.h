...
public:
    ...
    int  ReadDataRec();
    int  WriteDataRec();
    int  WriteDataRecAscii(FILE* ofp);

    int  ReadGSDataRec(void);
    int  WriteGSDataRec(void);
    int  FillGSFrame(void);
    int  WriteGSDataRecAscii(FILE* ofp);

    int  OpenCalPulseForWriting(const char* filename);
    int  OpenCalPulseForReading(const char* filename);
    int  ReadGSCalPulseRec();
    int  WriteGSCalPulseRec(void);
    int  WriteGSCalPulseRecAscii(FILE* ofp);
