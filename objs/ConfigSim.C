    ...
    ConfigList*  config_list)
{
    ...
    else if (strcasecmp(gmf_format, "QUIKSCAT_DUAL_POL_EXTENDED") == 0)
    {
        if (! gmf->ReadQScatStyleDualPolExtended(gmf_filename))
            return(0);
    }
    else if (strcasecmp(gmf_format, "SMAP_RADAR_ONLY") == 0)
    {
