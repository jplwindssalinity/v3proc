...
// vectors at the fringe of the tree.
// These arrays are accessed by dereferencing the pointer.
// For example: a[3][2][5][1] for a 4 dimensional array.  No bounds checking
// is provided, and the pointer returned by make_array needs to be cast
// into the proper form. (eg., float**** for a 4 dimensional array of floats.)
...
//
// dim_setup is the recursive function that performs the allocation.
//
...
//
// dim_free is the recursive function that performs deallocation.
//
