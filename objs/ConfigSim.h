...
int  ConfigAttitudeControlModel(AttDist* attctnl, ConfigList* config_list);

//--------------------------------//
// Attitude Knowledge Error Model //
//--------------------------------//

int  ConfigAttitudeKnowledgeModel(AttDist* attknow, ConfigList* config_list);
...
int  ConfigFbbTable(FbbTable* fbb_table, ConfigList* config_list);
