...
// 
//    Rev 1.40   25 Jun 1999 10:30:50   sally
// add some error conditions from Lee
// 
//    Rev 1.39   23 Jun 1999 11:56:00   sally
// Barry changed some entries
// 
//    Rev 1.38   14 Jun 1999 13:37:36   sally
// add NUM_SIGMA0_PER_CELL and change HK2_SRC_SEQ_COUNT to SRC_SEQ_COUNT
// 
...
enum ParamIdE
{
    ...
    CORR_MEM_ERR_CNT,
    UNCORR_MEM_ERR_CNT,
    SSR1_RX_STATUS_FIFO_FAULT,
    SSR1_XMIT_STATUS_FIFO_FAULT,
    SSR2_RX_STATUS_FIFO_FAULT,
    SSR2_XMIT_STATUS_FIFO_FAULT,
    ...
    WVC_ROW_TIME,
    NUM_SIGMA0_PER_CELL,
    FRAME_INST_STATUS_29,
    DISCRETE_STATUS_2_01,
    PBI_FLAG_00,
    PBI_FLAG_01,
    PBI_FLAG_02,
    PBI_FLAG_03,
    ...
    HEADER_GROUP_FLAG,
    HEADER_PACKET_LEN,
    SSR1_RX_STATUS_IF_ENB,
    SSR1_RX_STATUS_IF_RX,
    SSR1_XMIT_STATUS_IF_ENB,
    SSR2_RX_STATUS_IF_ENB,
    SSR2_RX_STATUS_IF_RX,
    SSR2_XMIT_STATUS_IF_ENB,
    WHEEL_TORQ_DIST_MATRIX,
    FLT_SW_VER_NO,
    OUTPUT_STATUS_QUEST,
    OUTPUT_STATUS_TWO_GUIDE
};
