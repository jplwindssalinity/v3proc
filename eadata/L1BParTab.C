...
const ParTabEntry L1BParTab[] =
{
  ...
  { ORBIT_TIME, "Orbit Time", SOURCE_L1B, MEAS_TIME, "orbit_time", 1, {
  ...
  { FRAME_QUALITY_FLAG, "Frame Quality", SOURCE_L1B,
  ...
  { FRAME_QUALITY_FLAG_00_01, "Frame Filler (Frame Quality)", SOURCE_L1B,
  ...
  { FRAME_QUALITY_FLAG_02_03, "Frame CRC Error (Frame Quality)", SOURCE_L1B,
            MEAS_STATUS, "frame_qual_flag", 1, {
  ...
  { FRAME_QUALITY_FLAG_04, "Data Quality (Frame Quality)",
            SOURCE_L1B, MEAS_STATUS, "frame_qual_flag", 1, {
      { UNIT_MAP, "0=Good, 1=Bad", DATA_UINT1, 0, Extract16Bit4, pr_bit}
    }
  },

  { NUM_PULSES, "Number of Pulses", SOURCE_L1B, MEAS_QUANTITY,
            "num_pulses", 1, {
      { UNIT_DN, "dn", DATA_INT1, 0, ExtractData1D, pr_int1 }
    }
  },
  { SC_LAT, "S/C Latitude", SOURCE_L1B, MEAS_LOCATION, "sc_lat", 2, {
  ...
  { SC_LON, "S/C Longitude", SOURCE_L1B, MEAS_LOCATION, "sc_lon", 2, {
      { UNIT_DEGREES, "degrees", DATA_FLOAT4, 0, ExtractData1D, pr_float4_6 },
      { UNIT_RADIANS, "radians", DATA_FLOAT4, 
                                   0, ExtractData1D_float_dtr, pr_float4_6}
    }
  },
  { SC_ALT, "S/C Altitude", SOURCE_L1B, MEAS_DISTANCE, "sc_alt", 2, {
  ...
  { X_POS, "X Component of S/C Position", SOURCE_L1B, MEAS_DISTANCE,
                "x_pos", 2, {
      { UNIT_METERS, "meters", DATA_FLOAT4, 0, ExtractData1D, pr_float4_6 },
      { UNIT_KILOMETERS, "km", DATA_FLOAT4, 0, ExtractData1D_m_km, pr_float4_6 }
    }
  },
  { Y_POS, "Y Component of S/C Position", SOURCE_L1B, MEAS_DISTANCE,
                "y_pos", 2, {
      { UNIT_METERS, "meters", DATA_FLOAT4, 0, ExtractData1D, pr_float4_6 },
      { UNIT_KILOMETERS, "km", DATA_FLOAT4, 0, ExtractData1D_m_km, pr_float4_6 }
    }
  },
  { Z_POS, "Z Component of S/C Position", SOURCE_L1B, MEAS_DISTANCE,
                "z_pos", 2, {
      { UNIT_METERS, "meters", DATA_FLOAT4, 0, ExtractData1D, pr_float4_6 },
      { UNIT_KILOMETERS, "km", DATA_FLOAT4, 0, ExtractData1D_m_km, pr_float4_6 }
    }
  },
  { X_VEL, "X Component of S/C Velocity", SOURCE_L1B, MEAS_VELOCITY,
                "x_vel", 2, {
      { UNIT_MPS, "m/s", DATA_FLOAT4, 0, ExtractData1D, pr_float4_6 },
      { UNIT_KMPS, "km/s", DATA_FLOAT4, 0, ExtractData1D_m_km, pr_float4_6 }
    }
  },
  { Y_VEL, "Y Component of S/C Velocity", SOURCE_L1B, MEAS_VELOCITY,
                "y_vel", 2, {
      { UNIT_MPS, "m/s", DATA_FLOAT4, 0, ExtractData1D, pr_float4_6 },
      { UNIT_KMPS, "km/s", DATA_FLOAT4, 0, ExtractData1D_m_km, pr_float4_6 }
    }
  },
  { Z_VEL, "Z Component of S/C Velocity", SOURCE_L1B, MEAS_VELOCITY,
                "z_vel", 2, {
      { UNIT_MPS, "m/s", DATA_FLOAT4, 0, ExtractData1D, pr_float4_6 },
      { UNIT_KMPS, "km/s", DATA_FLOAT4, 0, ExtractData1D_m_km, pr_float4_6 }
    }
  },
  { ROLL, "S/C Roll", SOURCE_L1B, MEAS_ORIENTATION, "roll", 2, {
  ...
  { PITCH, "S/C Pitch", SOURCE_L1B, MEAS_ORIENTATION, "pitch", 2, {
      { UNIT_DEGREES, "degrees", DATA_FLOAT4,
                           0, ExtractData1D_int2_float, pr_float4_6 },
      { UNIT_RADIANS, "radians", DATA_FLOAT4,
                           0, ExtractData1D_int2_float_dtr, pr_float4_6 }
  ...
  { YAW, "S/C Yaw", SOURCE_L1B, MEAS_ORIENTATION, "yaw", 2, {
      { UNIT_DEGREES, "degrees", DATA_FLOAT4,
                           0, ExtractData1D_int2_float, pr_float4_6 },
      { UNIT_RADIANS, "radians", DATA_FLOAT4,
                           0, ExtractData1D_int2_float_dtr, pr_float4_6 }
  ...
  { BANDWIDTH_RATIO, "Bandwidth Ratio", SOURCE_L1B, MEAS_POWER,
             "bandwidth_ratio", 1, {
      { UNIT_DB, "dB", DATA_FLOAT4, 0, ExtractData1D_int2_float, pr_float4_6 }
    }
  },
  { X_CAL_A, "Cal Value for A beam pulses", SOURCE_L1B, MEAS_POWER,
             "x_cal_A", 1, {
      { UNIT_DB, "dB", DATA_FLOAT4, 0, ExtractData1D_int2_float, pr_float4_6 }
    }
  },
  { X_CAL_B, "Cal Value for B beam pulses", SOURCE_L1B, MEAS_POWER,
             "x_cal_B", 1, {
      { UNIT_DB, "dB", DATA_FLOAT4, 0, ExtractData1D_int2_float, pr_float4_6 }
    }
  },
  { CELL_LAT, "Center Latitude for whole pulse", SOURCE_L1B,
  ...
  { CELL_LON, "Center Longitude for whole pulse", SOURCE_L1B,
  ...
  { SIGMA0_MODE_FLAG, "Sigma 0 Mode Flag", SOURCE_L1B, MEAS_STATUS,
             "sigma0_mode_flag", 1, {
      { UNIT_DN, "dn", DATA_UINT2_100, 0, ExtractData2D_100, pr_uint2_100 }
    }
  },
  { SIGMA0_QUAL_FLAG, "Sigma 0 Quality Flag", SOURCE_L1B, MEAS_STATUS,
             "sigma0_qual_flag", 1, {
      { UNIT_DN, "dn", DATA_UINT2_100, 0, ExtractData2D_100, pr_uint2_100 }
    }
  },
  ...
  { CELL_INCIDENCE, "Incidence for whole pulse", SOURCE_L1B,
  ...
  { ANTENNA_AZIMUTH, "Antenna Azimuth", SOURCE_L1B,
  ...
  { SLICE_QUAL_FLAG, "Slice Quality Flag", SOURCE_L1B,
                       MEAS_STATUS, "slice_qual_flag", 1, {
      { UNIT_DN, "dn", DATA_UINT4_100, 0, ExtractData2D_100, pr_uint4_100 }
    }
  },
  { SLICE_LAT, "Difference of Slice Latitude", SOURCE_L1B,
  ...
  { SLICE_LON, "Difference of Slice Longitude", SOURCE_L1B,
  ...
  { SLICE_SIGMA0, "Sigma 0 for each Slice", SOURCE_L1B,
                       MEAS_POWER, "slice_sigma0", 1, {
      { UNIT_DB, "dB", DATA_FLOAT4_100_8, 0,
                      ExtractData3D_100_8_int2_float, pr_100_8_float4_6 }
    }
  },
  { X_FACTOR, "X Factor for each Slice", SOURCE_L1B,
                       MEAS_POWER, "x_factor", 1, {
      { UNIT_DB, "dB", DATA_FLOAT4_100_8, 0,
                      ExtractData3D_100_8_int2_float, pr_100_8_float4_6 }
    }
  },
  { SLICE_AZIMUTH, "Azimuth for each Slice", SOURCE_L1B,
  ...
  { SLICE_INCIDENCE, "Incidence for each Slice", SOURCE_L1B,
  ...
  { SLICE_SNR, "Slice Signal to Noise Ratio", SOURCE_L1B,
                       MEAS_DATA, "slice_snr", 1, {
      { UNIT_DB, "dB", DATA_FLOAT4_100_8, 0,
                      ExtractData3D_100_8_int2_float, pr_100_8_float4_6 }
    }
  },
  { SLICE_KPC_A, "KPC for Each Slice", SOURCE_L1B,
